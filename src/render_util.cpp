...
unsigned int colorCubeVAO = 0;
unsigned int colorCubeVBO;
...
void renderColorQuad()
{
    if(rectVAO == 0)
    {
        ...
        std::vector<Vertex2> bloom_vertices =
        {
        ...
        std::vector<GLuint> bloom_indices =
        {
            0, 1, 2,
            0, 2, 3
        };
        ...
        glBufferData(GL_ARRAY_BUFFER, sizeof(bloom_rectangleVertices), &bloom_rectangleVertices, GL_STATIC_DRAW);
        glEnableVertexAttribArray(0);
